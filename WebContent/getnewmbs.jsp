...
String getpath(String uid){
	...
	return "image.jpg";
  	...
  	String lastmb = (String)user_session.getAttribute("lastmb");
  	if(lastmb==null){
  		//user_session.setAttribute("lastmb", "0");
  	...
  	pst.setString(1,uid);
  	pst.setString(2,lastmb);
  	ResultSet rs = pst.executeQuery();
  	if(rs.next()){
  		lastmb = new String(rs.getString(8));
  		user_session.setAttribute("lastmb", lastmb);
  	}
  	else{
  		return;
  	}
